#pragma checksum "C:\Users\Administrator\Desktop\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\Report.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5203b0fe26f2f3df335732192e5d476bb8bbdc13"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5203b0fe26f2f3df335732192e5d476bb8bbdc13", @"/Views/Processor/Report.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5203b0fe26f2f3df335732192e5d476bb8bbdc135854", async() => {
                WriteLiteral(@"
    ...
    <div class=""col-md-10"" style=""margin-top:8px;float:right;padding:0;"">
      <div class=""dropdown col-sm-1"" style=""margin-right:9px;float:right;padding:0;"">
        ...
        <div id=""contentexport"">
          <h4 id=""titlerelat""> Relatóriov Monitoramento Termografico</h4>
        ...
        <div class=""dropdown-menu export-pannel"" style=""margin-left:-80px;"">
          ...
          <ul class="" space-30"">
            ...
            <li class=""btn btn-default"" style=""width: 100%""> <a class=""dropdown-item"" id=""btn-export-xls"" href=""/u");
                WriteLiteral("rl/\">XLSX</a></li>\r\n          </ul>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n");
            }
            );
...
");
  ...
  <script>
    ...
    function Gerar(event) {
        ...
        if (Validate(dateRange)) {
          ");
                WriteLiteral(@"  ReportGenerate(dateRange)
        ...
        request.onload = function (e) {
            if (this.status === 200) {
                ...
                if (window.navigator.msSaveOrOpenBlob) {
                    ...
                    var co");
                WriteLiteral(@"ntentTypeHeader = request.getResponseHeader(""Content-Type"");
    ...
    function updatePagination() {
        ...
        if (pageNumber > 1) {
            paginationHTML +=
                '<li class=""page-item"">' +
                '<span class=""page-link"" disabled onclick=""changePage(-1)"">Anterior</span>' +
                '</li>'
        }
        ...
        for (var i = 0; i < numberOfPages; i++) {
            ...
            if (currentPage <= 3 || currentPage >= (numberOfPages - 3) || (currentPage <= (pageNumber + 3) && currentPage >= (page - 3))) {
                ...
                paginationHTML +=
                    ...
                    '<span class=""page-link"" onclick=""changePage(' + cur");
                WriteLiteral(@"rentPage + ', true)""> ' + currentPage + '  </span>' +
                    '</li>'
