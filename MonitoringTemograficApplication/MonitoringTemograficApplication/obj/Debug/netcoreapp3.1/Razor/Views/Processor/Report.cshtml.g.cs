#pragma checksum "C:\CSPNovo\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\Report.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ce733146d8c108d3655316199f6a8c5d67b0b88b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ce733146d8c108d3655316199f6a8c5d67b0b88b", @"/Views/Processor/Report.cshtml")]
                                ...
                                <div class=""col-md-10"" style=""margin-top:8px;float:right;padding:0;display: flex;align-items: center;"">
                                    <div class=""dropdown col-sm-1"" style=""margin-right:9px;float:right;padding:0;"">
                                        <div id=""contentexport"">
                                            ...
                                            <input style=""background-color:green; "" id=""inpexport"" type=""button"" value=""Expor");
            WriteLiteral(@"tar"" class=""btn btn-success   btnExport"" />
                                        </div>
    ...
    <script>
        ...
        function updatePagination() {
            ...
            if (pageNumber > 1) {
                paginationHTML +=
                    '<li  class=""page-item"">' +
                    '<span style= ""background-color:green;color:withe;"" class=""page-link"" disabled onclick=""changePage(-1)"">Anterior</span>' +
                    '</li>'
            }
            ...
            for (var i = 0; i < numberOfPages; i++) {
                ...
                if (currentPage <= 3 || currentPage >= (numberOfPages - 3) || (currentPage <= (pageNumber + 3) && currentPage >= (page - 3))) {
                    ...
                    paginationHTML +=
                        ...
                        '<span style= ""background-color:green;color:withe;"" class=""page-link"" onclick=""changePage(' + currentPage + ', true)""> ' + currentPage + '  </span>' +
                        '</li>'
                ...
                WriteLiteral(@"== 4) {
                    paginationHTML +=
                        '<li class=""page-item "">' +
                        '<span style= ""background-color:green;color:withe;"" class=""page-link""  > ...  </span>' +
                        '</li>'
            ...
            if (pageNumber < numberOfPages) {
                paginationHTML +=
                    '<li class=""page-item"">' +
                    '<span style= ""background-color:green;color:withe;"" class=""page-link"" disabled href=""#"" onclick=""changePage(1)"" value="""">Próximo</span>' +
                    '</li>' +
                    '</ul>'
            }
            ...
            $(tagetDiv).h");
                WriteLiteral("tml(paginationHTML)\r\n        }\r\n\r\n\r\n\r\n\r\n    </script>\r\n");
            }
            );
        }
