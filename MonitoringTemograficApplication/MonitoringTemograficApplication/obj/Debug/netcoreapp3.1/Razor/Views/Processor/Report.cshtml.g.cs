#pragma checksum "C:\CSPfeatureTable\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\Report.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ede2c2b26d32d7cc967c69d1323a6e07a0e9dc70"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ede2c2b26d32d7cc967c69d1323a6e07a0e9dc70", @"/Views/Processor/Report.cshtml")]
        ...
        <div class=""card"">
          <div class=""card-body"">
            ...
            WriteLiteral(@"ght:bold;""> </label>
                    ...
                    <div clwidth-md-12 title-container"" style=""border-radius:5px;height:50px;"">
            ...
            WriteLiteral(@"                 </div>
                  ...
                  <div class=""table-responsive"" id=""DivTbReport"">
                    ...
                    <div style=""position:relative"">
                      <div class=""stilpagnumber"" id=""numeropages"">
                      </div>
                      <nav class=""text-center"" id=""pagination"" style=""font-size:10px;position:relative;top:-23px;float:right"">
  ...
  <script>
    ...
    function DrawTable(response) {
        ...
        for (var i = 0; i < response.length; i++) {
            html +=
                ...
                ""<td>"" + response[i].time.slice(0, 19).replaceAl");
                WriteLiteral(@"l(""-"", ""/"").replaceAll(""T"", "" "") + ""</td>"" +
    ...
    function Validate(dateRange) {
        ...
        if (dateRange.dateStart.length > 10 || dateRange.dateEnd.length > 10) {
            ...
            if (d");
                WriteLiteral(@"ateRange.dateStart > dateRange.dateEnd) {
        ...
        request.onload = function (e) {
            if (this.status === 200) {
                ...
                if (window.navigator.msSaveOrOpenBlob) {
                    ");
                WriteLiteral(@"window.navigator.msSaveBlob(blob, ""monitoramentotermograficos.xlsx"");
                }
                else {
    ...
    function updatePagination() {
        ...
        if (pageNumber > 1) {
            paginationHTML +=
                '<li  class=""page-item"">' +
                '<span  class=""page-link  text-right"" disabled onclick=""changePage(-1)"">Anterior</span>' +
                '</li>'
        }
        ...
        for (var i = 0; i < numberOfPages; i++) {
            ...
            ");
                WriteLiteral(@"if (currentPage <= 3 || currentPage >= (numberOfPages - 3) || (currentPage <= (pageNumber + 3) && currentPage >= (page - 3))) {



                paginationHTML +=
                    '<li  class=""page-item  ' + (isCurrentPage ? 'active' : '') + '"">' +
                    '<span  class=""page-link   text-right"" onclick=""changePage(' + currentPage + ', true)""> ' + currentPage + '  </span>' +
                    '</li>'
                ...
                paginationHTML +=
                    '<li class=""page-item "">' +
                    '<span class=""page-link   text-right""  > ...  </span>' +
                    '</li>'
            }
        }
    ...
    ");
        ...
        var html = ""Página "" + pageNumber + "" de "" + numberOfPages + "" Páginas.""
        $(""#numeropages"").html(html)
    }
