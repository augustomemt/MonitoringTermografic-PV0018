#pragma checksum "C:\CSP.21.11\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\Report.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8a7e150858f338b7efae88f7b020fe94e8055241"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8a7e150858f338b7efae88f7b020fe94e8055241", @"/Views/Processor/Report.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 2 "C:\CSP.21.11\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\Report.cshtml"
...
#nullable disable
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8a7e150858f338b7efae88f7b020fe94e80552415634", async() => {
                WriteLiteral(@"
     ...
     ");
        ...
        function DrawTable(response) {
            ...
            function ajustarBotoes() {
                $('#proximo').prop('disabled', response.length <= tamanhoPagina || pagina > response.length / tamanhoPagina - 1);
                $('#anterior').prop('disabled', response.length <= tamanhoPagina || pagina == 0);
            }
            $(function() {
                $('#proximo').click(fun");
                WriteLiteral(@"ction() {
                    if (pagina < response.length / tamanhoPagina - 1) {
                        pagina++;
            ...
            var column = ""<th scope='col'>"" + 'ID das Imagens' + ""</th>"" +
                ...
                ""<th scope='col'>"" + ""Número da corrida"" + ");
                WriteLiteral(@"""</th>""
        ...
        function ExportExcel(dateRange) {
            ...
            var data = ""ExportXlsx?dateStart="" + dateRange.dateStart + ""&"" + ""dateEnd="" + date");
                WriteLiteral(@"Range.dateEnd;
            ...
            request.onload = function(e) {
                if (this.status === 200) {
                    ...
                    if (window.navigator.msSaveOrOpenBlob) {
                        ...
                        document.body.app");
                WriteLiteral(@"endChild(downloadLink);
                        downloadLink.click();
