#pragma checksum "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ab7c2f019aa0812d44ad9481bba973163c140459"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ab7c2f019aa0812d44ad9481bba973163c140459", @"/Views/Processor/MeasurementExist.cshtml")]
...
");
#nullable restore
#line 53 "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml"
...
#nullable disable
            WriteLiteral("</td>\r\n            <td>");
#nullable restore
#line 60 "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml"
...
#nullable disable
            ...
            BeginWriteAttribute("onclick", " onclick=\"", 1894, "\"", 1955, 3);
            WriteAttributeValue("", 1904, "pegarMeasurmentPeloId(", 1904, 22, true);
#nullable restore
...
WriteAttributeValue("", 1926, measurements.MeasurementKey, 1926, 28, false);
...
#nullable restore
#line 63 "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml"
...
#nullable disable
            WriteLiteral("      </tbody>\r\n\r\n    </table>\r\n    <div id=\"DivBtn\">\r\n      ");
#nullable restore
#line 69 "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml"
...
#nullable disable
            WriteLiteral("\r\n    </div>\r\n  </div>\r\n");
#nullable restore
#line 76 "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml"
}
else
{
...
");
#nullable restore
#line 95 "C:\ValidationCSP\MonitoringTermografic-PV0018\MonitoringTemograficApplication\MonitoringTemograficApplication\Views\Processor\MeasurementExist.cshtml"
}
  ...
  <script>
    ...
    $("".btnSalvar"").click(function () {
      var Measurement = {
        ...
        ");
                WriteLiteral(@"LadleAge: $('.LadleAge').val(),
        LadleID: $('.LadleID').val(),
    ...
    function ValidarFormulario(Measurement) {
        ...
        let validaRace = ValidarRace(Mea");
                WriteLiteral(@"surement.RaceNumber);
      ...
      function ValidarCompare(Measurement) {
        ...
        if (parseInt(Measurement.LadleAge) != parseInt(Measurement.LadleAgeValidate) && parseInt(Measurement.LadleID) == parseInt(Measurement.LadleIDValidate)) {
          ...
          $("".erroID"").text(""É necessario altera o Numero da panela  "");
          $("".erroID"").removeClass(""d-none"");
          result = false;

        }
        if (parseInt(Measurement.LadleAge) == parseInt(Measurement.LadleAgeValidate) && parseInt(Measurement.LadleID) != parseInt(Measurement.LadleIDValidate)) {
          $("".LadleAge"").addClass('is-inva");
                WriteLiteral(@"lid');
          $("".erroAge"").text(""É necessario alterar o Id da panela. "");
      ...
      function ValiditId(LadleID) {
        ...
        if (isNaN(LadleID) || LadleID == undefined || LadleID == """") {
          ...
          $("".erroID"").text(""Pree");
                WriteLiteral(@"ncha o ID da panela"");
          $("".erroID"").removeClass(""d-none"");
